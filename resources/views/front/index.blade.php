                ...
                <div class="col-lg-8 offset-lg-1">
                    <div class="filter-control">
                        <ul>
                            ...
                            <li class="item" data-tag=".Accesccories" data-category="women">Accesccories</li>
                        </ul>
                    </div>
                    <div class="product-slider owl-carousel women">
                        @foreach ($featuredProducts['women'] as $item)
                ...
                <div class="col-lg-8">
                    <div class="filter-control">
                        <ul>
                            ...
                            <li class="item" data-tag=".Accesccories" data-category="men">Accesccories</li>
                        </ul>
                    </div>
                    <div class="product-slider owl-carousel men">
                        @foreach ($featuredProducts['men'] as $item)
                            @include('front.components.product-item')
                        @endforeach
                    </div>
                </div>
