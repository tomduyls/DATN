            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumb-text">
                        ...
                        <a href="./account/my-account"></i> My Account</a>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="main-card mb-3 card">
                <div class="card-body">
                    <form method="post" action="/account/my-account/edit" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="position-relative row form-group mb-1">
                            <div class="col-md-9 col-xl-8 offset-md-2">
                                <a href="./account/my-account" class="border-0 btn btn-outline-danger mr-1">
